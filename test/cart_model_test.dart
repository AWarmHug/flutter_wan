...
import 'package:flutter_wan/tools/widget/provider/shopping/model/cart_model.dart';
...
void main() {
  test("test CartModel.totalMoney", () {
    CartModel cartModel = CartModel();
    CatalogModel catalogModel = CatalogModel();

    cartModel.catalog = catalogModel;

    cartModel.add(CatalogModel.items[0]);
    cartModel.totalMoney == CatalogModel.items[0].price;
  });
